        ...
        <div class="one">
          ...
          <div class="right">
            ...
            <div class="three">
              ...
              <span
                >2023年3月至4月，安徽省组委会设立，并组织全省报名相关事宜，参赛团队需要通过官方微信
公众号“全球发明大会安徽赛区”或官方网站 http://www.icc.ah.cn/了解参赛流程，按要求进行报名注册和提交参赛材料。更多信息咨询可以添加组委会服务微信。</span
              >
              <strong>2023年5月至6月——省级选拔赛</strong>
              <span
                >2023年5月至6月，安徽省市组委会根据属地学情，举办线上或线下“全球发明大会中国区安徽
省级竞赛活动”，筛选出进入到全国总决赛的参赛团队。
              </span>
...
.pmd-outer{
    ...
    .pmd-article{
        ...
        // 标题后面的详细内容
        .pmd-articleDetail{
            // 设置这个margin主要适用于03里面的新布局
            margin-bottom: 30px;
            .pmd-articleDetailTitle{
                color: #ff9900;
                font-size: 23px;
                margin-bottom: 20px;
            }
